...
magnet_length = 1E-2
magnet_radius = 4E-3
magnet_volume = magnet_length * pi * (magnet_radius)**2
magnet_magnetic_moment = 4500/10000*magnet_volume/miu0

bullet = cylinder(pos=vector(-inductor_length/2, 0, 0),
                  axis=vector(magnet_length, 0, 0), radius=magnet_radius)
...
while bullet.pos.x <= inductor_length/2*3:
    ...
    F = magnet_magnetic_moment * grad_B
    a = F/magnet_mass
    bullet.v.x += a*dt
    ...
    t += dt
print("capacitor = ",C)
print("magnetic moment = ",magnet_magnetic_moment)
